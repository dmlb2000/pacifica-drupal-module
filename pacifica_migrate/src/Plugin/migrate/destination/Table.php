...
namespace Drupal\pacifica_migrate\Plugin\migrate\destination;
...
class Table extends DestinationBase implements ContainerFactoryPluginInterface {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    ...
    print_r($values);
    $mapping = array_combine(array_keys($id), array_keys($this->idFields));
    $new_id = array();
    foreach($mapping as $src_id => $dest_id){
      $new_id[$dest_id] = $id[$src_id];
    }
